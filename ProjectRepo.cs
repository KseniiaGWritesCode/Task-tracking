...
namespace TaskTracking
{
    public class ProjectRepo
    {
        ...
        private void ProjectDataToSql(NpgsqlCommand command, Project project)
        {
            ...
            command.Parameters.AddWithValue("manager", project.Manager.ToString());
        ...
        public Project? GetProject(string name, string sql)
        {
            ...
            if(reader.Read())
            {
                return new Project()
                {
                    ...
                    Manager = 
                    //в проекте менеджер и создавший имеют тип Coworker, как их получать?
                };
            }
        }
    }
